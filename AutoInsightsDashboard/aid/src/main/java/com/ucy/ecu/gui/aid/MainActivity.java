...
import static com.ucy.ecu.gui.aid.SettingsActivity.ELM_TIMING_SELECT;
		           ...
		           AbsListView.MultiChoiceModeListener
{
	...
	private static final String TAG = "AutoInsightsDashboard";
	/**
	...
	private void onCreatePreferenceFragment() {
		getFragmentManager().beginTransaction()
				.replace(R.id.activity_settings_container, new MyPreferenceFragment ())
				.commit();
	}
...
//		AndroidAutoPlugin an = new AndroidAutoPlugin();
		Intent auto = new Intent(this,AndroidAutoPlugin.class);
		startService(auto);
